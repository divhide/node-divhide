...
describe("SubModules.Schema.Mixins.SchemaExecutionHelper", function() {
    ...
    it(".prepareValue() should return the value", function() {
    ...
    it(".prepareValue() .object() should return the value", function() {
    ...
    it(".prepareValue() .array() should return the value", function() {
    ...
    it(".prepareValue() .required(false) null value should return null", function() {
    ...
    it(".prepareValue() .strict(false) literal values should be coerced", function() {
    ...
    it(".prepareValue() .strict(true) literal values shouldn't be coerced", function() {
    ...
    it(".prepareValue() .require(true) null value should throw error", function() {
    ...
    it(".prepareValue() wrong types should throw errors", function() {
    ...
    it(".prepareValue() validations function should be executed", function() {
    ...
    it(".prepareSchema() primitive schema should return the schema", function() {
    ...
    it(".prepareSchema() wrong types should throw errors", function() {
    ...
    it(".prepareSchema() .strict(false) wrong types should thow error", function() {
    ...
    it(".prepareSchema() .default() should throw error", function() {
        ...
        var errors = null;
        try {
            Helper.prepareSchema(c, undefined);
        } catch(e) {
            errors = e;
        }
    ...
    it(".prepareSchema() .required() null values should throw errors", function() {
    ...
    it(".prepareSchema() .any().optional() should accept null values", function() {
    ...
    it(".prepareSchema() .any().required() null values should throw error", function() {
    ...
    it(".prepareSchema() .object()", function() {
    ...
    it(".prepareSchema() .object() keys should accept regex", function() {
    ...
    ///
    /// .prepareSchema() array tests
    ///
    
    it(".prepareSchema() .array().repeatable(true)", function() {
    ...
    it(".prepareSchema() .array().repeatable(true) errors", function() {
    ...
    it(".prepareSchema() .array().repeatable(false)", function() {
    ...
    it(".prepareSchema() .array().repeatable(false) errors", function() {
